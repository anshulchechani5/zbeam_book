					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "Beam Book Report - pp",
									"targetURL": "#zppbeambook-display"
								}
							}]
						}]
					}
						...
						"inbounds": {
							"zppbeambook-display": {
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=zppbeambook",
									"url": sap.ui.require.toUrl("zppbeambook")
								}
							}
						}
					}
